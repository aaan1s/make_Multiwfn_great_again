...
real*8 stresstens(3,3),divstress(3),stresseval(3),stressevect(3,3) ! Stress tensor thingy
real*8 temp
integer N
...
call CalcStressTensor(2,inx,iny,inz,stresstens,divstress)
write(ifileid,*) "Stress tensor:"
write(ifileid,"(3E18.10)") stresstens
write(ifileid,"(' Divergence of Stress Tensor:',3E18.10)") divstress(1:3)
!call diagmat(stresstens,stressevect,stresseval,300,1D-12)
call diagsymat(stresstens,stressevect,stresseval,idiagok)
if (idiagok/=0) write(*,*) "Note: Diagonization of Hessian matrix failed!"
N=size(stresseval)
do i=1,N-1
	do j=i+1,N
...
write(ifileid,"(' Eigenvalues of Stress Tensor:',3E18.10)") stresseval(1:3)
write(ifileid,*) "Eigenvectors(columns) of Stress Tensor:"
write(ifileid,"(3E18.10)") ((stressevect(i,j),j=1,3),i=1,3)
