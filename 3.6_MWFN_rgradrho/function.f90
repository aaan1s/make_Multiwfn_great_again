...
else if (ifunc==211) then
calcfuncall=fgrad(x,y,z,'x')
else if (ifunc==212) then
calcfuncall=fgrad(x,y,z,'y')
else if (ifunc==213) then
calcfuncall=fgrad(x,y,z,'z')
else if (ifunc==214) then
calcfuncall=dot_product((/x-refx,y-refy,z-refz/),(/fgrad(x,y,z,'x'),fgrad(x,y,z,'y'),fgrad(x,y,z,'z')/))
else if (ifunc==215) then
    calcfuncall=dot_product((/x-refx,y-refy,z-refz/),(/fgrad(x,y,z,'x'),fgrad(x,y,z,'y'),fgrad(x,y,z,'z')/))
    if (calcfuncall>0) then
        calcfuncall=0
    end if

else if (ifunc==221) then
	calcfuncall=(x-refx)*fgrad(x,y,z,'x')
else if (ifunc==222) then
	calcfuncall=(y-refy)*fgrad(x,y,z,'x')
else if (ifunc==223) then
	calcfuncall=(z-refz)*fgrad(x,y,z,'x')
else if (ifunc==224) then
	calcfuncall=(x-refx)*fgrad(x,y,z,'y')
else if (ifunc==225) then
	calcfuncall=(y-refy)*fgrad(x,y,z,'y')
else if (ifunc==226) then
	calcfuncall=(z-refz)*fgrad(x,y,z,'y')
else if (ifunc==227) then
	calcfuncall=(x-refx)*fgrad(x,y,z,'z')
else if (ifunc==228) then
	calcfuncall=(y-refy)*fgrad(x,y,z,'z')
else if (ifunc==229) then
	calcfuncall=(z-refz)*fgrad(x,y,z,'z')

else if (ifunc==231) then 
	calcfuncall=fRgradRho(x,y,z,'o')	
else if (ifunc==232) then 
	calcfuncall=fRgradRho(x,y,z,'d')	
else if (ifunc==233) then 
	calcfuncall=fRgradRho(x,y,z,'t')	

else if (ifunc==241) then 
	calcfuncall=fRgradRho(x,y,z,'1')	
else if (ifunc==242) then 
	calcfuncall=fRgradRho(x,y,z,'2')	
else if (ifunc==243) then 
	calcfuncall=fRgradRho(x,y,z,'3')	
else if (ifunc==244) then 
	calcfuncall=fRgradRho(x,y,z,'4')	
else if (ifunc==245) then 
	calcfuncall=fRgradRho(x,y,z,'5')	
else if (ifunc==246) then 
	calcfuncall=fRgradRho(x,y,z,'6')	
else if (ifunc==247) then 
	calcfuncall=fRgradRho(x,y,z,'7')	
else if (ifunc==248) then 
	calcfuncall=fRgradRho(x,y,z,'8')	
else if (ifunc==249) then 
	calcfuncall=fRgradRho(x,y,z,'9')	

else if (ifunc==251) then
	calcfuncall=refx*fgrad(x,y,z,'x')
else if (ifunc==252) then
	calcfuncall=refy*fgrad(x,y,z,'x')
else if (ifunc==253) then
	calcfuncall=refz*fgrad(x,y,z,'x')
else if (ifunc==254) then
	calcfuncall=refx*fgrad(x,y,z,'y')
else if (ifunc==255) then
	calcfuncall=refy*fgrad(x,y,z,'y')
else if (ifunc==256) then
	calcfuncall=refz*fgrad(x,y,z,'y')
else if (ifunc==257) then
	calcfuncall=refx*fgrad(x,y,z,'z')
else if (ifunc==258) then
	calcfuncall=refy*fgrad(x,y,z,'z')
else if (ifunc==259) then
	calcfuncall=refz*fgrad(x,y,z,'z')
...
real*8 function fRgradRho(x,y,z,label)
use util
real*8 x,y,z,wfnval(nmo),wfnderv(3,nmo),gradrho(3),EDFgrad(3)
real*8 rgrad(3,3), eigvecmat(3,3), eigval(3)
character label
...
rgrad(1,1)=gradrho(1)*(x-refx)
rgrad(2,1)=gradrho(1)*(y-refy)
rgrad(3,1)=gradrho(1)*(z-refz)
rgrad(1,2)=gradrho(2)*(x-refx)
rgrad(2,2)=gradrho(2)*(y-refy)
rgrad(3,2)=gradrho(2)*(z-refz)
rgrad(1,3)=gradrho(3)*(x-refx)
rgrad(2,3)=gradrho(3)*(y-refy)
rgrad(3,3)=gradrho(3)*(z-refz)

call diagmat(rgrad,eigvecmat,eigval,300,1D-10)
...
if (label=='o') then
	...
	fRgradRho=eigvecmat(1,1)
else if (label=='2') then
	fRgradRho=eigvecmat(1,2)
else if (label=='3') then
	fRgradRho=eigvecmat(1,3)
	
else if (label=='4') then
	fRgradRho=eigvecmat(2,1)
else if (label=='5') then
	fRgradRho=eigvecmat(2,2)
else if (label=='6') then
	fRgradRho=eigvecmat(2,3)

else if (label=='7') then
	fRgradRho=eigvecmat(3,1)
else if (label=='8') then
	fRgradRho=eigvecmat(3,2)
else if (label=='9') then
	fRgradRho=eigvecmat(3,3)
...
if (allocated(b)) then
	...
	write(*,*) "211 Gradient x pt."
	write(*,*) "212 Gradient y pt."
	write(*,*) "213 Gradient z pt."
	write(*,*) "214 RefR dot GradRho"
	write(*,*) "215 RefR dot GradRho (< 0)"
	write(*,*) "221-229 RefR dot GradRho matrix (r_i*grad_j)"
	write(*,*) "231-233 RefR dot GradRho matrix evals"
	write(*,*) "241-249 RefR dot GradRho matrix evects"
